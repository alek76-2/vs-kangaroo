...
unsigned long rndl_fixed() {// Original renamed function
...
void RandAddSeed()
{
	...
	//printf("\nPerformanceCounter() nCounter: %lld \n", nCounter);
...
unsigned long rndl() {
	...
	//return rk_random(&localState); the delete	
	...
	unsigned long *vTmp = (unsigned long *)&buf;
