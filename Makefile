...
SRC = Base58.cpp IntGroup.cpp main.cpp Random.cpp \
      ...
      hash/sha256_sse.cpp Bech32.cpp Backup.cpp
...
OBJET = $(addprefix $(OBJDIR)/, \
        ...
        GPU/GPUEngine.o Bech32.o Backup.o)
...
OBJET = $(addprefix $(OBJDIR)/, \
        ...
        IntMod.o Point.o SECP256K1.o Vanity.o GPU/GPUGenerate.o \
        hash/ripemd160.o hash/sha256.o hash/sha512.o \
        hash/ripemd160_sse.o hash/sha256_sse.o Bech32.o Backup.o)
...
vs-kangaroo-multi-divide: $(OBJET)
	...
	@echo The forked software created 30.10.2023 by Alek-76 fixed modify v0.18 ...
